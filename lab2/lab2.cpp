...
void Lab2::Init()
{
    ...
    // by definition!
    {
        ...
        {
            VertexFormat(glm::vec3(0.5, 1,  0.5), glm::vec3(0, 1, 0), glm::vec3(0.7, 0.8, 0.6)),
            VertexFormat(glm::vec3(1, 0,  0), glm::vec3(0, 1, 0), glm::vec3(0.7, 0.8, 0.6)),
            VertexFormat(glm::vec3(0, 0,  1), glm::vec3(1, 0, 0), glm::vec3(0.7, 0.8, 0.6)),
            VertexFormat(glm::vec3(0, 0,  0), glm::vec3(1, 0, 0), glm::vec3(0.7, 0.8, 0.6)),
            // TODO(student): Complete the vertices data for the cube mesh
    ...
    // opposing vertex orientations.
    {
        ...
        {
            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(0, 1, 0), glm::vec3(0.7, 0.8, 0.6)),
            VertexFormat(glm::vec3(0, 1, 0), glm::vec3(0, 1, 0), glm::vec3(0.7, 0.8, 0.6)),
            VertexFormat(glm::vec3(1, 1, 0), glm::vec3(1, 0, 0), glm::vec3(0.7, 0.8, 0.6)),
            VertexFormat(glm::vec3(1, 0, 0), glm::vec3(1, 0, 0), glm::vec3(0.7, 0.8, 0.6)),
            // TODO(student): Complete the vertices data for the cube mesh
